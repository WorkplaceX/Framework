...
SELECT NEWID(), Id FROM FrameworkApplication

GO
EXEC FrameworkConfigurationPathUpdate
GO

INSERT INTO FrameworkSession (Name, LanguageId, ApplicationId)
SELECT NEWID(), LanguageLanguageId, ApplicationId FROM FrameworkLanguageView 
