namespace Framework.Test
{
    ...
    public static class UnitTestMd
    {
        public static void Run()
        {
            ...
            list.Add(new Item { TextMd = "# T\n(Note)\nHello\n(Note)", TextHtml = "<section>(page)<h1>T</h1><p>(p)(/p)</p><article class=\"message is-warning\"><div class=\"message-body\"><p>(p)Hello(/p)</p></div></article>(/page)</section>" });
            list.Add(new Item { TextMd = "\r\n\r\n(Note)\r\nHello\r\n(Note)", TextHtml = "<section>(page)<p>(p)(/p)</p><article class=\"message is-warning\"><div class=\"message-body\"><p>(p)Hello(/p)</p></div></article>(/page)</section>" });
            list.Add(new Item { TextMd = "(Note)\r\nD\r\n\r\nE\r\n(Note)", TextHtml = "<section>(page)<article class=\"message is-warning\"><div class=\"message-body\"><p>(p)D(/p)</p><p>(p)E(/p)</p></div></article>(/page)</section>" });
            ...
            list.Add(new Item { TextMd = "(Note)Hello\r\n(Note)", TextHtml = "<section>(page)<article class=\"message is-warning\"><div class=\"message-body\"><p>(p)Hello(/p)</p></div></article>(/page)</section>" });
            list.Add(new Item { TextMd = "(Note)Hello\r\n\r\nWorld\r\n(Note)", TextHtml = "<section>(page)<article class=\"message is-warning\"><div class=\"message-body\"><p>(p)Hello(/p)</p><p>(p)World(/p)</p></div></article>(/page)</section>" });
            ...
            list.Add(new Item { TextMd = "(Note)\r\nHello**Bold**\r\n(Note)", TextHtml = "<section>(page)<article class=\"message is-warning\"><div class=\"message-body\"><p>(p)Hello<strong>Bold</strong>(/p)</p></div></article>(/page)</section>" });
            list.Add(new Item { TextMd = "(Note)\r\n**Note:**\r\n(Note)", TextHtml = "<section>(page)<article class=\"message is-warning\"><div class=\"message-body\"><p>(p)<strong>Note:</strong>(/p)</p></div></article>(/page)</section>" });
            list.Add(new Item { TextMd = "(Note)\r\n\r\nA\r\n(Note)", TextHtml = "<section>(page)<article class=\"message is-warning\"><div class=\"message-body\"><p>(p)A(/p)</p></div></article>(/page)</section>" });
            list.Add(new Item { TextMd = "(Note)\r\n\r\nHello\r\n\r\n# A\r\n# B\r\n(Note)", TextHtml = "<section>(page)<article class=\"message is-warning\"><div class=\"message-body\"><p>(p)Hello(/p)</p><p>(p)(/p)</p></div></article><h1>A</h1><p>(p)(/p)</p><h1>B</h1><p>(p)(/p)</p>(/page)</section>" });
            list.Add(new Item { TextMd = "(Note)\r\n\r\n* A\r\n(Note)", TextHtml = "<section>(page)<article class=\"message is-warning\"><div class=\"message-body\"><p>(p)(/p)</p></div></article><ul><li>A</li></ul>(/page)</section>" });
