namespace Framework.Test
{
    ...
    public static class UnitTestMd
    {
        public static void Run()
        {
            ...
            list.Add(new Item { TextMd = "(Note)\r\n\r\n* A\r\n(Note)", TextHtml = "<article class=\"message is-warning\"><div class=\"message-body\"><p>(p)(/p)</p></div></article><ul><li>A</li></ul>" });
            list.Add(new Item { TextMd = "(Note)\r\n# X5\r\n**Bold**\r\n(Note)", TextHtml = "<article class=\"message is-warning\"><div class=\"message-body\"></div></article><h1>X5</h1><p>(p)<strong>Bold</strong>(/p)</p>" });
