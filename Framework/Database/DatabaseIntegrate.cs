    ...
    public static class FrameworkConfigGridIntegrateFramework
    {
        ...
        public static List<FrameworkConfigGridIntegrate> RowList
        {
            get
            {
                ...
                {
                    new FrameworkConfigGridIntegrate { Id = 0, IdName = "dbo.FrameworkConfigFieldDisplay; ", TableId = 0, TableIdName = "dbo.FrameworkConfigFieldDisplay", TableNameCSharp = "dbo.FrameworkConfigFieldDisplay", ConfigName = null, RowCountMax = null, WidthMax = null, IsAllowInsert = false, IsShowHeader = null, IsShowPagination = null, IsDelete = false },
                    new FrameworkConfigGridIntegrate { Id = 0, IdName = "dbo.FrameworkConfigFieldDisplay; Developer", TableId = 0, TableIdName = "dbo.FrameworkConfigFieldDisplay", TableNameCSharp = "dbo.FrameworkConfigFieldDisplay", ConfigName = "Developer", RowCountMax = null, WidthMax = null, IsAllowInsert = false, IsShowHeader = null, IsShowPagination = null, IsDelete = false },
