...
@NgModule({
  declarations: [
    AppComponent, Selector, Page, Button, Html, Div, DivContainer, BingMap, Dialpad, BulmaNavbarComponent, BulmaNavbarMenuComponent, GridComponent, BootstrapNavbarComponent, Custom01Component, Custom02Component, Custom03Component
  ],
  imports: [
